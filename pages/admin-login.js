      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-display font-bold" style={{ color: 'var(--color-text)' }}>
              Admin Login
            </h1>
            <p className="text-sm mt-1 opacity-50" style={{ color: 'var(--color-text)' }}>
              Khareef Dashboard
            </p>
          </div>
          ...
          <p className="text-center text-xs opacity-30 mt-6" style={{ color: 'var(--color-text)' }}>
